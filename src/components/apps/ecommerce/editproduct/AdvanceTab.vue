                ...
                <v-row>
                    ...
                    <v-col cols="12">
                        ...
                        <div class="d-md-flex gap-3 ">
                            <VTextField type="number" value="15" placeholder="Width (w)" variant="outlined" class="mb-md-0 mb-3" hide-details></VTextField>
                            <VTextField type="number" value="12" placeholder="Height (h)" variant="outlined" class="mb-md-0 mb-3" hide-details></VTextField>
                            <VTextField type="number" value="18" placeholder="Lengtn (l)" variant="outlined" class="mb-md-0 mb-3" hide-details></VTextField>
                        </div>
